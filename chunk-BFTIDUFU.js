...
`,ga={root:({instance:t})=>{let s=typeof t.value=="function"?t.value():t.value,e=typeof t.size=="function"?t.size():t.size,n=typeof t.badgeSize=="function"?t.badgeSize():t.badgeSize,i=typeof t.severity=="function"?t.severity():t.severity;return["p-badge p-component",{"p-badge-circle":Pe(s)&&String(s).length===1,"p-badge-dot":vt(s),"p-badge-sm":e==="small"||n==="small","p-badge-lg":e==="large"||n==="large","p-badge-xl":e==="xlarge"||n==="xlarge","p-badge-info":i==="info","p-badge-success":i==="success","p-badge-warn":i==="warn","p-badge-danger":i==="danger","p-badge-secondary":i==="secondary","p-badge-contrast":i==="contrast"}]}},ko=(()=>{class t extends ${name="badge";style=fa;classes=ga;static \u0275fac=(()=>{let e;return function(i){return(e||(e=_(t)))(i||t)}})();static \u0275prov=j({token:t,factory:t.\u0275fac})}return t})();var Mo=new G("BADGE_INSTANCE");var Cn=(()=>{class t extends U{componentName="Badge";$pcBadge=f(Mo,{optional:!0,skipSelf:!0})??void 0;bindDirectiveInstance=f(S,{self:!0});onAfterViewChecked(){this.bindDirectiveInstance.setAttrs(this.ptms(["host","root"]))}styleClass=b();badgeSize=b();size=b();severity=b();value=b();badgeDisabled=b(!1,{transform:T});_componentStyle=f(ko);get dataP(){return this.cn({circle:this.value()!=null&&String(this.value()).length===1,empty:this.value()==null,disabled:this.badgeDisabled(),[this.severity()]:this.severity(),[this.size()]:this.size()})}static \u0275fac=(()=>{let e;return function(i){return(e||(e=_(t)))(i||t)}})();static \u0275cmp=D({type:t,selectors:[["p-badge"]],hostVars:5,hostBindings:function(n,i){n&2&&(F("data-p",i.dataP),v(i.cn(i.cx("root"),i.styleClass())),Xe("display",i.badgeDisabled()?"none":null))},inputs:{styleClass:[1,"styleClass"],badgeSize:[1,"badgeSize"],size:[1,"size"],severity:[1,"severity"],value:[1,"value"],badgeDisabled:[1,"badgeDisabled"]},features:[R([ko,{provide:Mo,useExisting:t},{provide:Y,useExisting:t}]),ae([S]),I],decls:1,vars:1,template:function(n,i){n&1&&C(0),n&2&&de(i.value())},dependencies:[ce,ee,xe],encapsulation:2,changeDetection:0})}return t})(),Do=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=le({type:t});static \u0275inj=se({imports:[Cn,ee,ee]})}return t})();var Lo=`
    .p-button {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
