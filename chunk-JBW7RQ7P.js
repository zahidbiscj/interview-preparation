...
`;var Xo=["*"],Jo={root:({instance:t})=>["p-iconfield",{"p-iconfield-left":t.iconPosition=="left","p-iconfield-right":t.iconPosition=="right"}]},ki=(()=>{class t extends z{name="iconfield";style=Oi;classes=Jo;static \u0275fac=(()=>{let e;return function(i){return(e||(e=_(t)))(i||t)}})();static \u0275prov=j({token:t,factory:t.\u0275fac})}return t})();var Mi=new Q("ICONFIELD_INSTANCE"),Di=(()=>{class t extends W{componentName="IconField";hostName="";_componentStyle=m(ki);$pcIconField=m(Mi,{optional:!0,skipSelf:!0})??void 0;bindDirectiveInstance=m(S,{self:!0});onAfterViewChecked(){this.bindDirectiveInstance.setAttrs(this.ptms(["host","root"]))}iconPosition="left";styleClass;static \u0275fac=(()=>{let e;return function(i){return(e||(e=_(t)))(i||t)}})();static \u0275cmp=M({type:t,selectors:[["p-iconfield"],["p-iconField"],["p-icon-field"]],hostVars:2,hostBindings:function(n,i){n&2&&v(i.cn(i.cx("root"),i.styleClass))},inputs:{hostName:"hostName",iconPosition:"iconPosition",styleClass:"styleClass"},features:[H([ki,{provide:Mi,useExisting:t},{provide:U,useExisting:t}]),le([S]),I],ngContentSelectors:Xo,decls:1,vars:0,template:function(n,i){n&1&&(ge(),me(0))},dependencies:[de,xe],encapsulation:2,changeDetection:0})}return t})();var es=["*"],ts=`
.p-icon {
    display: inline-block;
